    ...
    <div className="hub-container">
      ...
      <section className="profile-section">
        <div className="profile-img-container">
          <img loading="lazy" src={data.profileImgUrl} alt={data.name} className="profile-img" onError={(e) => { e.target.src = 'https://ui-avatars.com/api/?name=Alfonso+Recio&background=12C7CF&color=fff&size=200' }} />
        </div>
      </section>
